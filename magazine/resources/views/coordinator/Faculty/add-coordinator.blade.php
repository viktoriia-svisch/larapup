...
@section("coordinator-content")
    <div class="container" style="margin-bottom: 10vw">
        ...
        <div class="row col-md-12 m-auto">
            ...
            <div class="row col-12">
                <div class="col-sm-6">
                    <h4 style="text-align: center">Free coordinator</h4>
                    <input style="margin-top: 1vw" class="form-control" type="text" placeholder="search" id="search-available-coordinator">
                    <hr>
                    <div class="col-12" id="coordinator-available">
                    </div>
                </div>
                <div class="col-sm-6">
                    <h4 style="text-align: center">List coordinator of selected faculty</h4>
                    <input style="margin-top: 1vw" class="form-control" type="text" placeholder="search" id="search-unavailable-coordinator">
                    <hr>
