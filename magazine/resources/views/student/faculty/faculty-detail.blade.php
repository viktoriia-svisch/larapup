    ...
    <div class="container-fluid row">
        <div class="col-sm-12 col-md-8">
            <div class="col-12">
                ...
                <h1 class="heading-title">{{$facultySemester->faculty->name}}</h1>
                <hr>
            </div>
            <div class="col-12">
            ...
            <div class="col-12 row">
                <div class="col-12 col-sm-6">
                    ...
                    <h3>{{\App\Helpers\DateTimeHelper::formatDateTime($facultySemester->first_deadline)}}</h3>
                </div>
                <div class="col-12 col-sm-6">
                    <span class="text-muted">Second deadline</span>
                    <h3>{{\App\Helpers\DateTimeHelper::formatDateTime($facultySemester->second_deadline)}}</h3>
                </div>
            </div>
        </div>
