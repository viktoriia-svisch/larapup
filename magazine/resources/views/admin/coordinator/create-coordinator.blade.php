...
<div class="container row col-md-12" style="margin-bottom: 10vw">
    ...
    <div class="col-sm-5">
        ...
        <hr>
        <form action="{{route('admin.createStudent_post')}}" method="post">
            ...
            <div class="row col-xl-12" style="margin-top: 2vw; margin-right: -1vw">
                ...
                <input class="col-xl-1" type="radio" placeholder="Male" required>
                <p class="col-xl-2" style="margin-top: -0.30vw">Male</p>
                <input class="col-xl-1" type="radio" placeholder="Female" required>
            ...
            <hr>
            <button class="btn btn-danger col-sm-12" type="submit">Create</button>
        </form>
    </div>
    <div class="col-sm-2">
    </div>
