...
Route::group([
    ...
    Route::get('semesterS', 'SemesterController@semesterSearch')->name('admin.semesterSearch');
    ...
    Route::post('semester/update/{id}', 'SemesterController@updateSemesterPost')->name('admin.updateSemesterPost');
