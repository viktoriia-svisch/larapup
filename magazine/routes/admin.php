...
Route::group([
    ...
    Route::post('student/create', 'AdminController@createStudent_post')->name('admin.createStudent_post');
    ...
    Route::get('faculty/create', 'AdminController@createFaculty')->name('admin.createFaculty');
