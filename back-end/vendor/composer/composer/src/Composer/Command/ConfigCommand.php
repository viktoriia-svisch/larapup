...
To add a repository:
    <comment>%command.full_name% repositories.foo vcs https:
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (preg_match('/^repos?(?:itories)?\.(.+)/', $settingKey, $matches)) {
            ...
            throw new \RuntimeException('You must pass the type and a url. Example: php composer.phar config repositories.foo vcs https:
        }
