...
class TranslatorTest extends TestCase
{
    ...
    public function getCssToXPathTestData()
    {
        return [
            ...
            ['e:nth-child(1)', "**[(name() = 'e') and (position() = last() - 0)]"],
            ['e:nth-last-child(2n+2)', "*e[position() = 1]'],
            ['e:nth-last-of-type(1)', '*/e[position() = last() - 0]'],
            ['div e:nth-last-of-type(1) .aclass', "div/descendant-or-self::*/e[position() = last() - 0]/descendant-or-self::**[(name() = 'e') and (position() = 1)]"],
            ['e:last-child', "*e[position() = 1]'],
