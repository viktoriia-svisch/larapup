...
class RequestTest extends TestCase
{
    ...
    public function testCreateWithRequestUri()
    {
        ...
        $this->assertFalse($request->isSecure());
        $request = Request::create('https:
        $request->server->set('REQUEST_URI', 'https:
        $this->assertEquals('https:
        $this->assertEquals('/foo', $request->getPathInfo());
        $this->assertEquals('test.com', $request->getHost());
        $this->assertEquals('test.com', $request->getHttpHost());
    ...
    public function testGetAcceptableContentTypes()
    {
        ...
        $this->assertEquals(['application/vnd.wap.wmlscriptc', 'text/vnd.wap.wml', 'application/vnd.wap.xhtml+xml', 'application/xhtml+xml', 'text/html', 'multipart/mixed', '*
    ...
    public function nonstandardRequestsData()
    {
        return [
            ...
            ['hello/x',  '', '/x', 'http:
            ['/hello/x', '', '/x', 'http:
            ['hello/app.php/x',      'a=b', '/x', 'http:
            ['hello/app.php/x?a=b',  'a=b', '/x', 'http:
            ['/hello/app.php/x?a=b', 'a=b', '/x', 'http:
        ];
    }
