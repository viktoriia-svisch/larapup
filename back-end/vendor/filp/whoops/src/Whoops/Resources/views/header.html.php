    ...
    <ul class="search-for-help">
      ...
      <li>
        <a rel="noopener noreferrer" target="_blank" href="<?php echo $docref_url; ?>" title="Search for help in the PHP manual.">
          ...
          <svg height="16px" id="Layer_1" style="enable-background:new 0 0 32 32;" version="1.1" viewBox="0 0 32 32" width="16px" xml:space="preserve" xmlns="http:
        </a>
      </li>
      <?php endif ?>
      <li>
        <a rel="noopener noreferrer" target="_blank" href="https:
          <!-- Google icon by Alfredo H, from https:
          <!-- Creative Commons (Attribution 3.0 Unported) -->
          <!-- http:
          <svg class="google" height="16" viewBox="0 0 512 512" width="16" xmlns="http:
      ...
      <li>
        <a rel="noopener noreferrer" target="_blank" href="https:
          <!-- DuckDuckGo icon by IconBaandar Team, from https:
          <!-- Creative Commons (Attribution 3.0 Unported) -->
          <!-- http:
          <svg class="duckduckgo" height="16" viewBox="150 150 1675 1675" width="16" xmlns="http:
      ...
      <li>
        <a rel="noopener noreferrer" target="_blank" href="https:
          <!-- Stack Overflow icon by Picons.me, from https:
          <!-- Free for commercial use -->
          <svg class="stackoverflow" height="16" viewBox="-1163 1657.697 56.693 56.693" width="16" xmlns="http:
